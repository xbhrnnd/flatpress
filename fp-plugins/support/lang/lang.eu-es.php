<?php
$lang ['admin'] ['maintain'] ['submenu'] ['support'] = 'Erakutsi euskarriaren datuak';

$lang ['admin'] ['maintain'] ['support'] = array(
	'title' => 'Euskarriaren datuak',
	'intro' => 'Akatsen berri emateko eta laguntza jasotzeko bisitatu <a href="https://forum.flatpress.org" target="_blank">FlatPressen foroa</a>, ' . //
		'akatsaren berri eman <a href="https://github.com/flatpressblog/flatpress/issues" target="_blank">GitHub</a>en ' . //
		'edo <a href="mailto:hello@flatpress.org">bidali mezu elektroniko bat</a>. Erantsi orri honetan agertzen diren datuak ingelesez (kopiatu eta itsatsi) ' . //
		'informazio honekin: akatsaren deskribapena, erreproduzitzeko urratsak.',
